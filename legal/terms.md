...
## 3. Decisions are suggestions
Loupe's decisions, rankings, warnings and drafts are produced by a model and rules that **can be wrong**. A missing warning does not mean something is safe; Loupe never says a site or email is safe. **You decide** what to do, and you are responsible for your actions. Loupe is not financial, legal, medical, travel or security advice.

## 4. No booking or payment
Loupe never books, buys or pays for anything, and never fills in passwords, codes or card details. Prices, schedules, rates and weather come from third parties and may be out of date; check with the provider before relying on them.

## 5. Your accounts, keys and third-party services
Some features use services you connect yourself: Google, Microsoft, your mail provider, Composio, AI providers, Google Safe Browsing, Duffel and others. You are responsible for your accounts and API keys, for any fees charged by those providers, and for following their terms. Keys you add stay on your device. We do not control third-party services and are not responsible for them, their availability or their charges.

## 6. Acceptable use
Do not use Loupe to: access accounts, mailboxes or data you are not authorised to access; break the law or others' rights; abuse, overload, scrape or attempt to bypass limits on the Loupe web helper; reverse engineer the apps except where the law allows; or use it to build a competing service from the helper. We may block helper access that breaks these rules.

## 7. Online features
Online features are optional and may be limited, changed or discontinued at any time, and may be unavailable. Loupe keeps working offline without them.
...
## 11. Governing law
These terms are governed by the laws of the Arab Republic of Egypt, and disputes go to the courts of Hurghada, Red Sea Governorate, Egypt, unless the law of your country gives you the right to bring claims at home.

## 12. Changes
We may update these terms. We will post the new version here with a new effective date and, for material changes, tell you in the app. If you keep using Loupe after that, the new terms apply.

## 13. Language
An Arabic translation is provided for convenience. If the versions differ, the English version controls.
