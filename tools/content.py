...
DIFFS = {
 "en": [
  ...
  ("game", "Riverflight — watch the model decide live", "A river shooter where Laya flies, with its raw probability bars on screen, against a dumb autopilot on the same seed.", "60 fps · p50 ~63 ms"),
 ...
 "ar": [
  ...
  ("game", "Riverflight — شاهد النموذج يقرّر مباشرةً", "لعبة نهر يقودها Laya وأشرطة احتمالاته الخام على الشاشة، في مواجهة طيّار آلي بسيط على البذرة نفسها.", "60 fps · p50 ~63 ms"),
